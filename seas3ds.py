...
# ตั้งค่าหน้าเว็บ
st.set_page_config(
    page_title="ระบบคัดเลือกนักเรียนเพื่อสอบเข้า ม.1 และ ม.4",
    page_icon="🏫",
    layout="wide"
)

# ส่วนหัวของแอปพลิเคชัน
st.title("🏫 ระบบคัดเลือกนักเรียนเพื่อสอบเข้า ม.1 และ ม.4")
st.markdown("---")
...
if menu == "หน้าหลัก":
    st.subheader("ยินดีต้อนรับสู่ระบบคัดเลือกนักเรียน")
